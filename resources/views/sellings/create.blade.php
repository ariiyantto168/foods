<section class="content-header">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                {{ Form::open(array('url' => 'sellings/create-new', 'class' => 'form-horizontal')) }}
                     <div class="x_content">
                        <br />
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control datepicker pull-right" name="date" id="date" data-date-format='yyyy-mm-dd' value="{{date('Y-m-d')}}" autocomplete="off">
                                         </div>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="text" value="AUTO" class="form-control" readonly col-md-7 col-xs-12">
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <input type="number" id="totalall" name="totalall" value="0" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td  style="border: 1px solid #d2d6de !important; ">
                                                ...
                                                <select class="form-control select2" name="idfoods[]" id="idfoods_1" onchange="passing_price(1,this.value);">
                                            ...
                                            <td  style="border: 1px solid #d2d6de !important; ">
                                                ...
                                                <input type="number" name="quantity[]" onkeyup="count_value(1)" value="0" class="form-control"  id="quantity_1">
                                            </td>
                                            <td  style="border: 1px solid #d2d6de !important; ">
                                            ...
                                            <td  style="border: 1px solid #d2d6de !important; ">
                                                ...
                                                <input type="number" name="totalsendiri[]" class="form-control"  id="total_1" value="0" onkeyup="total(1)">
                                            </td>
                                        </tr>
                                        </tbody>
                                        </table>
